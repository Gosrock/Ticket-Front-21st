function setLayout(sceneInfo, yOffset, currentScene) {
  //각 스크롤 섹션의 높이 세팅
...
function calcValues(values, currentYOffset, sceneInfo, currentScene) {
  let rv;
...
function playAnimaition(sceneInfo, yOffset, prevScrollHeight, currentScene) {
...
function scrollLoop(
  ...
  playAnimaition(sceneInfo, yOffset, prevScrollHeight, currentScene);
}
...
const mainAnimation = () => {
  ...
  //   });
  window.addEventListener('load', setLayout(sceneInfo, yOffset, currentScene));
